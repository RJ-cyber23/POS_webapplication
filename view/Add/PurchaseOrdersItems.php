...
<!--hero section-->
                <div class="container-solid py- rounded-5 ">
                        <div class="p-5 mb-4 lc-block">
                            <div class="lc-block">
                                <div editable="rich">
                                    <h3><i class="bi bi-box-seam me-2 fs-1"></i>Add Purchase Order Items</h3>
                                </div>
                            </div>
<!--hero section end-->
                ...
                <div style="max-width: 800px; width: 100%;">
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <label for="Purchase_Orders_Items_id" class="form-label">Purchase Orders Items ID</label>
                            <input type="text" class="form-control form-control-sm" name="Purchase_Orders_Items_id" id="Purchase_Orders_Items_id">
                    ...
                    <div class="row mb-2">
                         ...
                         <div class="col">
                        <label for="ordered_quantity" class="form-label">Ordered Quantity</label>
                        <input type="text" class="form-control form-control-sm" name="ordered_quantity" id="ordered_quantity">
                        </div>


                         <div class="col">
                        <label for="purchase_cost_price" class="form-label">Purchase Cost Price</label>
                        <input type="text" class="form-control form-control-sm" name="purchase_cost_price" id="purchase_cost_price">
                        </div>
                    </div>
                    <!-- More rows and inputs here -->
                    <div class="d-flex justify-content-between p-3">
                    <button type="submit" name="add_purchaseorderitems" class="btn btn-primary btn-md">Add Purchase Orders Items</button>
