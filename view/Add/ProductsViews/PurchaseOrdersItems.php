	...
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
                        <?php
                        $conn=(new PurchaseOrdersItemsReadModel())->purchaseOrdersItemsRead();
                        foreach ($conn as $row): ?>
                            <tr>
                                <td>
                                    <span class="custom-checkbox">
                                        <input type="checkbox" id="<?=htmlspecialchars($row['Purchase_Orders_Items_id']);?>" name="options[]" value="<?=htmlspecialchars($row['Purchase_Orders_Items_id']);?>">
                                        <label for="checkbox1<?=htmlspecialchars($row['Purchase_Orders_Items_id']);?>"></label>
                                    </span>
                                </td>
                                ...
                                <td><?=htmlspecialchars($row['purchase_cost_price']);?></td>
                                ...
                                <td> 
                                    ...
                                    <form method="POST" style="display:inline;">
                                        <input type="hidden" name="Purchase_Orders_Items_id" value="<?= htmlspecialchars($row['Purchase_Orders_Items_id']); ?>">
